# 1 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino"
// PinOut for ESP8266
// SDA D2
// SCL D1
// RST D4
...
# 8 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 9 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 10 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 11 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 12 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 13 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2
# 14 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino" 2




# 17 "/home/esarandon/Arduino/esp32/espNow/slave/slave.ino"
// Eink config
...
void setup()
{
    Serial.begin(115200);
    WiFi.mode(WIFI_AP);
    WiFi.softAP("RX_DHT22", "RX_DHT22_Password", 1, 0);
...
void printEink(float temperature, float humidity){
    ...
    eink_segments[4] = digit_right[temperature_digits[2]] | 32 /* decimal point */;
    ...
    eink_segments[8] = digit_right[humidity_digits[1]] | 32 /* decimal point */;
    eink_segments[9] = digit_left[humidity_digits[2]];
    eink_segments[10] = digit_right[humidity_digits[2]] | 32 /* percentage sign */;
